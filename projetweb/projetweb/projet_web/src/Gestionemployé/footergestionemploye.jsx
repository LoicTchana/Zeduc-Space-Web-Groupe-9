...
import locationIcon from '../assets/localisation.png'; // Remplace par le chemin de ton image
import HomeImage from '../assets/Icon.png'; // Remplace par le chemin de ton image
import messageIcon from '../assets/Mail.png'; // Remplace par le chemin de ton image
import phoneIcon from '../assets/Phone.png'; // Remplace par le chemin de ton image
import './footergestionemploye.css'

const FootergestionEmploye = () => {
  return (
    <footer>
...
export default FootergestionEmploye;