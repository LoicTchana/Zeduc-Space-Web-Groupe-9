...
import './validerReclamationsHeader.css'   // On va ajouter un fichier CSS pour les styles
import Zeducimage from '../assets/Zeduc.jpg'; // Syntaxe pour importer l'image 
...
const HeadervaliderReclamation = () => {
    return (
  ...
  export default HeadervaliderReclamation;