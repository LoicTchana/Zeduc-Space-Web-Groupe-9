...
import './suiviCommandeHeader.css'   // On va ajouter un fichier CSS pour les styles
import Zeducimage from '../assets/Zeduc.jpg'; // Syntaxe pour utiliser l'image
...
const HeadersuiviCommande = () => {
  ...
  export default HeadersuiviCommande;